...
class NetworkHead(nn.Module):
    ...
    Attributes:
        ...
        output_activation (nn.Activation| func) : at inint output_activation should be a function or torch.nn.Activation subclass.
    """
    ...
    def __init__(self, output_dim: int, hidden: nn.Module, lr=None):
        ...
        self.lr = lr
        self.hidden = hidden
        self._hidden_ouput_dim = inspect_output_dim(hidden)
